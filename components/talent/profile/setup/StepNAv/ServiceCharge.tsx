...
function ServiceCharge({ setActiveStep }: ServiceChargeProps) {
      ...
      <Dialog open={isFinished} onOpenChange={resetDialog}>
        <DialogContent className="w-full p-[3rem] sm:max- lg:max-w-[25rem]">
          ...
          <div className="text-center mt-4">
            <DialogClose>
              <Button type="button" className="px-24 py-6 flex-center" onClick={() => setActiveStep(4)}>
                Done
              </Button>
            </DialogClose>
          </div>
  ...
  return (
    <div>
      <button
        ...
        className="bg-[#F5F5F5] rounded-full h-8 w-8 flex items-center justify-center mr-10"
      >
