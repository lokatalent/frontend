...
function DropDownElement() {
	...
	return (
		<div className="flex gap-2 my-8 max-w-xl">
			<div className="flex-1">
				<Select
					value={selectedService}
					onValueChange={handleServiceChange}
				>
					<SelectTrigger className="appearance-none w-ful h-16 px-2 pr-8 text-lg bg-transparent border-2 border-white rounded-md focus:outline-none">
						{selectedService ? (
			...
			<div className="bg-[#ede8e8] h-16 w-16 rounded flex items-center justify-center">
