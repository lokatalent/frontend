...
const LogInAuth = () => {
  ...
  return (
    <div className="w-8/12 mx-auto pt-20 pb-6 space-y-6 h-screen lg:h-max">
      <div className="text-center space-y-2">
        <h1 className="font-bold text-3xl md:text-4xl text-textColor py-4">Welcome Back</h1>
        <p className=" mx-auto">
      ...
      <footer className="flex justify-center gap-2 ">
        <p className="text-sm font-bold text-gray-600">Dont have an account?</p>
