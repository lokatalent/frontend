		...
		<div className="sm:px-[4rem]  md:px-[6rem] lg:px-[7rem] py-12 flex justify-cnter flex-col items-cener gap-12 bg-[#FAF8F4]">
			...
			<div className="flex justify-center">
				<Link
					...
					className="font-nunito text-sm text-[#fff] bg-[#3377FF] font-normal leading-6 w-[20rem] sm:w-[30rem] md:w-[32rem] lg:w-[30rem] rounded h-14 flex items-center justify-center hover:text-[#3377FF] hover:bg-white hover:border-2 hover:border-[#3377ff]  transition-all duration-[500ms]"
				>
					Login
				</Link>
			</div>
