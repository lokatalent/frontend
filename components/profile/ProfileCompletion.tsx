  ...
  return (
    <div className="bg-white w-full rounded-br-md rounded-tr-md p-6 flex justify-between items-center border-[#DF8600] border-l-[5px]">
        <div className="flex items-center space-x-6">
          ...
          <p className=" text-sm">You have to complete your profile set up</p>
        </div>
        <div>
          <Link href="/dashboard/profile/edit" className="text-white h-10 rounded-md py-2 bg-primaryBlue px-[3rem]">
            Complete
          </Link>
        </div>
      </div>
