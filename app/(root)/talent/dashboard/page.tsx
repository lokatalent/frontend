    ...
    <div className=" w-11/12 mx-auto">
      <div className="w-full flex justify-between items-center">
        ...
        <div className="flex items-center space-x-3">
          <div className="flex items-center text-textGray4 space-x-2">
            <p>Status</p>
            <MdOutlineInfo size={12} />
          </div>
          <div className="flex items-center space-x-3">
            <span className="inline-flex items-center justify-center w-2 h-2 text-xs font-bold leading-none text-white bg-online rounded-full"></span>
            <h3 className="text-online">Online</h3>
          </div>
          <div>
            <Button className="px-8">Go Offline</Button>
          </div>
        </div>
      </div>

      <div className="flex flex-col md:flex-row space-x-3 md:space-y-0 justify-between w-full py-10  ">
        <InfoCard
          text="No of Bookings"
          number={19}
